...
fn match_grad(
	...
	match grad_mode {
		...
		GradMode::PaletteTerrain => {
			gradients::palettes::terrain::get(array)
		}
		GradMode::PaletteBiomes => {
			gradients::palettes::biomes::get(array)
		}
		GradMode::PaletteRainfall => {
			gradients::palettes::rainfall::get(array)
		}
		GradMode::PaletteTemperature => {
			gradients::palettes::temperature::get(array)
		}
		GradMode::PaletteRegionSize => {
			gradients::palettes::region_size::get(array)
		}
		GradMode::PaletteRiverWidth => {
			gradients::palettes::river_width::get(array)
		}
		...
		GradMode::RawBinaryInverse => {
			gradients::raw::get_binary_inverse(array)
		}
		...
		GradMode::BlueBinaryInverse => {
			gradients::blue::get_binary_inverse(array)
		}
