	...
	for i in 0..render_size * 2 {
		...
		for j in (0..render_size * 2).rev() {
				...
				&& ((y as usize) < map_size)
			{
				...
				let element = match river_width {
					//⁓≃≅≈≊≋
					1 => ".⁓".truecolor(70, 100, 145),
					2 => "⁓⁓".truecolor(70, 100, 145),
					3 => "⁓⩪".truecolor(70, 100, 145),
					4 => "⩪⩪".truecolor(70, 130, 190),
					5 => "⩪≃".truecolor(70, 130, 190),
					6 => "≃≃".truecolor(70, 130, 190),
					7 => "≃≊".truecolor(70, 150, 230),
					8 => "≊≊".truecolor(70, 150, 230),
					9 => "≊≋".truecolor(70, 150, 230),
					10 => "≋≋".truecolor(70, 195, 230),
					11 => "≋⩭".truecolor(70, 195, 230),
					12 => "⩰⩰".truecolor(70, 195, 230),
					...
					_ => {
						...
						match biome {
							0 => "⁓⁓" //water
								.on_truecolor(argb[1], argb[2], argb[3]),
							1 => "⁓⁓" //water
								.on_truecolor(argb[1], argb[2], argb[3]),
							2 => "⁓⁓" //water
								.on_truecolor(argb[1], argb[2], argb[3]),
